        ...
        <div class="w-full max-w-md rounded-xl border border-gray-200 bg-white shadow-2xs dark:border-gray-700 dark:bg-gray-800">
            <div class="p-4 sm:p-7">
                ...
                <div class="text-center">
                    <h1 id="hs-modal-signup-label" class="block text-2xl font-bold text-gray-800 dark:text-white">
                        Sign up
                    </h1>
                ...
                <form action="{{ Route::has('register') ? route('register') : '#' }}" method="POST">
                    ...
                    <div class="grid gap-y-4">
                        <!-- Form Group -->
                        <div>
                            <label for="name" class="mb-2 block text-sm text-gray-700 dark:text-gray-300">Name</label>
                            <div class="relative">
                                <input
                                    type="text"
                                    id="name"
                            ...
                            @error('name')
                                <p class="mt-2 text-xs text-red-600 dark:text-red-400" id="name-error">
                                    {{ $message }}
                                </p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            @error('email')
                                <p class="mt-2 text-xs text-red-600 dark:text-red-400" id="email-error">
                                    {{ $message }}
                                </p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <div class="pointer-events-none absolute inset-y-0 inset-e-0 hidden pe-3">
                                    <svg class="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.001 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
                                    </svg>
                                </div>
                            </div>
                            @error('password')
                        ...
                        <!-- Form Group -->
                        <div>
                            <label for="confirm-password" class="mb-2 block text-sm text-gray-700 dark:text-gray-300"
                            ...
                            @error('password_confirmation')
                                <p class="mt-2 text-xs text-red-600 dark:text-red-400" id="confirm-password-error">
                                    {{ $message }}
                                </p>
                            @enderror
                        </div>
